Footer Area
==============================-->
    <footer class="footer-wrapper footer-default" data-bg-src="{{ asset('assets/img/bg/footer-default-bg-mask.png') }}">
                        ...
                        <div class="widget footer-widget">
                            <div class="th-widget-about">
                                <div class="about-logo">
                                    <a href="index.html"><img src="{{ asset('assets/img/Asn-upendo.jpg') }}" alt="Asn Upendo Village"></a>
                                </div>
                ...
                <div class="row justify-content-center gy-3 align-items-center">
                    <div class="col-lg-12">
                        <p class="copyright-text text-center">
                            <i class="fal fa-copyright"></i> Copyright 2025 <a href="{{ route('home') }}">Asn Upendo Village</a>. All Rights Reserved. | Designed by <a target="_blank" href="https://breezetech.co.ke/">Breezetech </a>
                        </p>
                    </div>
                </div>
            </div>
