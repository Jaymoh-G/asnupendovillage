        ...
        <div class="swiper th-slider hero-slider1" id="heroSlide1" data-slider-options='{"effect":"fade", "autoHeight": "true"}'>
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="hero-inner" data-bg-src="{{ asset('assets/img/hero/hero_bg_1_1.jpg') }}" data-overlay="black4" data-opacity="5">
                        <div class="hero-bg-shape1-1">
                            <img src="{{ asset('assets/img/hero/hero-bg-shape1-1.png') }}" alt="img">
                        </div>
                        <div class="container">
                ...
                <div class="swiper-slide">
                    <div class="hero-inner" data-bg-src="{{ asset('assets/img/hero/hero_bg_1_2.jpg') }}" data-overlay="black4" data-opacity="5">
                        <div class="hero-bg-shape1-1">
                            <img src="{{ asset('assets/img/hero/hero-bg-shape1-1.png') }}" alt="img">
                        </div>
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-xl-12">
                                    <div class="hero-style1 text-center">
                                        <span class="sub-title justify-content-center" data-ani="slideinup" data-ani-delay="0.2s">Welcome to Asn Upendo Village</span>
                                        <h1 class="hero-title text-white">
                                            <span class="title1" data-ani="slideinup" data-ani-delay="0.4s">
...
Service Area
==============================-->
    <section class="overflow-hidden space" id="service-sec" data-bg-src="{{ asset('assets/img/bg/gray-bg1.png') }}" data-overlay="gray" data-opacity="6">
        <div class="shape-mockup service-bg-shape1-1 d-xxl-inline-block d-none" data-top="15%" data-left="0">
            <div class="color-masking">
                <div class="masking-src" data-mask-src="{{ asset('assets/img/shape/hand-shape1.png') }}"></div>
                <img src="{{ asset('assets/img/shape/hand-shape1.png') }}" alt="img">
            </div>
        </div>
        <div class="shape-mockup service-bg-shape1-2 d-xxl-inline-block d-none" data-top="35%" data-left="0">
            <div class="color-masking">
                <div class="masking-src" data-mask-src="{{ asset('assets/img/shape/hand-shape2.png') }}"></div>
                <img src="{{ asset('assets/img/shape/hand-shape2.png') }}" alt="img">
            </div>
        </div>
            ...
            <div class="row gy-30 gx-30 justify-content-center">
                <div class="col-xl-4 col-md-6">
                    <div class="service-card">
                        <div class="box-icon">
                            <img src="{{ asset('assets/img/icon/service-icon/service-card-icon1-1.svg') }}" alt="Icon">
                        </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="service-card">
                        <div class="box-icon">
                            <img src="{{ asset('assets/img/icon/service-icon/service-card-icon1-2.svg') }}" alt="Icon">
                        </div>
                        <div class="box-content">
                            <h3 class="box-title"><a href="about.html">Educations</a></h3>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="service-card">
                        <div class="box-icon">
                            <img src="{{ asset('assets/img/icon/service-icon/service-card-icon1-3.svg') }}" alt="Icon">
                        </div>
                        <div class="box-content">
                ...
                <div class="col-xl-7">
                    <div class="img-box1">
                        <div class="img1" data-mask-src="{{ asset('assets/img/normal/about_1_1-mask.png') }}">
                            <img src="{{ asset('assets/img/normal/about_1_1.png') }}" alt="About">
                        </div>
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-6">
                        <div class="cta-card style2" data-bg-src="{{ asset('assets/img/bg/cta-bg1-2.jpg') }}">
                            <div class="shape-mockup cta-card-bg-shape" data-bottom="0" data-left="0" data-mask-src="{{ asset('assets/img/shape/cta_shape1_1.png') }}">
                                <img src="{{ asset('assets/img/shape/cta_shape1_1.png') }}" alt="img">
                        </div>
...
Donation Area
==============================-->
    <section class="space bg-gray" data-bg-src="{{ asset('assets/img/bg/donation-bg1-1.png') }}" id="donation-sec">
        <div class="shape-mockup donation-bg-shape1-1" data-bottom="0" data-right="0"><img src="{{ asset('assets/img/shape/donation-shape1-1.png') }}" alt="shape"></div>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="title-area text-center">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="donation-card" data-theme-color="">
                                <div class="donation-card-shape" data-mask-src="{{ asset('assets/img/donation/donation-card-bg-shape1-1.png') }}"></div>
                                <div class="box-thumb">
                                    <img src="{{ asset('assets/img/donation/donation1-1.png') }}" alt="image">
                        ...
                        <div class="swiper-slide">
                            <div class="donation-card" data-theme-color="var(--theme-color2)">
                                <div class="donation-card-shape" data-mask-src="{{ asset('assets/img/donation/donation-card-bg-shape1-1.png') }}"></div>
                                <div class="box-thumb">
                                    <img src="{{ asset('assets/img/donation/donation1-2.png') }}" alt="image">
                                    <div class="donation-card-tag">85%</div>
                                </div>
                                <div class="box-content">
                        ...
                        <div class="swiper-slide">
                            <div class="donation-card" data-theme-color="#FF5528">
                                <div class="donation-card-shape" data-mask-src="{{ asset('assets/img/donation/donation-card-bg-shape1-1.png') }}"></div>
                                <div class="box-thumb">
                                    <img src="{{ asset('assets/img/donation/donation1-3.png') }}" alt="image">
                                    <div class="donation-card-tag">85%</div>
                                </div>
                                <div class="box-content">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="th-team team-card">
                                <div class="img-wrap">
                                    <div class="team-img">
                                        <img src="{{ asset('assets/img/team/team_1_4.png') }}" alt="Team">
                                    </div>
                                    <div class="team-social-hover">
                                        <a href="#" class="team-social-hover_btn">
                                            <i class="far fa-plus"></i>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="title-area text-center">
                        ...
                        <h2 class="sec-title">What People Say About Us
                           </h2>
                    </div>
                </div>
            </div>
