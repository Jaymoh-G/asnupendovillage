                    ...
                    <aside class="sidebar-area">
                        <div class="widget widget_categories">
                            ...
                            <ul>
                                ...
                                <li>
                                    <strong>Time:</strong> {{ \Carbon\Carbon::parse($event->start_date)->format('g:i A') }}
                                </li>
                                @if($event->end_date)
                                <li>
                                    <strong>End Time:</strong> {{ \Carbon\Carbon::parse($event->end_date)->format('g:i A') }}
                                </li>
                                @endif
                                @if($event->location)
                                <li>
