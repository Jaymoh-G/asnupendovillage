                ...
                <div class="col-xxl-8 col-lg-7">
                    <div class="donation-form-v1">
                        <p class="donation-form-notice">
                            ...
                            ><span class="text-title">Notice:</span> Test mode
                            is enabled. While in test mode no live donations are
                            processed.
                        </p>
                        <form
                            action="mail.php"
                        ...
                        >
                            ...
                            <ul class="donate-amount-button-list list-unstyled">
                                ...
                                <li
                                    class="donate-amount-button active"
                                    data-amount="100"
                                >
                                    $100
                                </li>
                            ...
                            <div class="widget-donation-card">
                                <div class="box-content">
                                    ...
                                    <p class="box-text">
                                        ...
                                        supporters by becoming a member.
                                    </p>
                                </div>
                                <div class="donation-progress-wrap">
                                    <div class="media-left">
                                        ...
                                        <div class="donation-progress-content">
                                            <span
                                                class="donation-card_raise text-title"
                                                >Raised<span class="ms-1 me-1"
                                                    >-</span
                                                >5M</span
                                            >
                                            <span
                                                class="donation-card_goal text-theme"
                                                >Goal<span class="ms-1 me-1"
                                                    >-</span
                                                >$10M</span
                                            >
                                        </div>
                        ...
                        >
                            <div class="author-widget-wrap">
                                ...
                                <div class="author-info">
                                    <h4 class="name">
                                        <a class="text-inherit" href="blog.html"
                                            >Emanuel Marko</a
                                        >
                                    </h4>
                                    <span class="meta">
