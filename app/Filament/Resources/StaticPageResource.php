                ...
                Forms\Components\Section::make('Content Section 1')
                    ->schema([
                        ...
                        Forms\Components\FileUpload::make('section1_images')
                            ...
                            ->image()
                            ->imageEditor()
                            ->imageCropAspectRatio(fn(\Filament\Forms\Get $get) => in_array($get('page_name'), ['founder', 'about-us']) ? '3:4' : '16:9')
                            ->imageResizeTargetWidth(fn(\Filament\Forms\Get $get) => in_array($get('page_name'), ['founder', 'about-us']) ? 900 : 800)
                            ->imageResizeTargetHeight(fn(\Filament\Forms\Get $get) => in_array($get('page_name'), ['founder', 'about-us']) ? 1200 : 450)
                            ->disk('public')
                            ->directory('static-pages/section1')
                            ->visibility('public')
                            ->maxSize(5120)
                            ->helperText('Images for section 1. Founder & About Us use portrait (3:4); others use landscape (16:9).')
                            ->acceptedFileTypes(['image/jpeg', 'image/png', 'image/webp'])
                            ->columnSpanFull(),
                    ])
                    ->collapsible()
                ...
                Forms\Components\Section::make('Content Section 2')
                    ->schema([
                        ...
                        Forms\Components\FileUpload::make('section2_images')
                            ...
                            ->visibility('public')
                            ->maxSize(5120)
                            ->helperText('Images for section 2. Founder & About Us use portrait (3:4); others use landscape (16:9).')
                            ->acceptedFileTypes(['image/jpeg', 'image/png', 'image/webp'])
                            ->columnSpanFull(),
                    ])
                    ->collapsible()
                ...
                Forms\Components\Section::make('Content Section 3')
                    ->schema([
                        ...
                        Forms\Components\FileUpload::make('section3_images')
                            ...
                            ->visibility('public')
                            ->maxSize(5120)
                            ->helperText('Images for section 3. Founder & About Us use portrait (3:4); others use landscape (16:9).')
                            ->acceptedFileTypes(['image/jpeg', 'image/png', 'image/webp'])
                            ->columnSpanFull(),
                    ])
                    ->collapsible()
