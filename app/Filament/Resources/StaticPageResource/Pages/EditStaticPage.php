                ...
                \Filament\Forms\Components\Section::make('Content Section 1')
                    ->schema([
                        ...
                        \Filament\Forms\Components\FileUpload::make('section1_images')
                            ...
                            ->image()
                            ->imageEditor()
                            ->imageCropAspectRatio(fn(Get $get) => in_array($get('page_name'), ['founder', 'about-us']) ? '3:4' : '16:9')
                            ->imageResizeTargetWidth(fn(Get $get) => in_array($get('page_name'), ['founder', 'about-us']) ? 900 : 800)
                            ->imageResizeTargetHeight(fn(Get $get) => in_array($get('page_name'), ['founder', 'about-us']) ? 1200 : 450)
